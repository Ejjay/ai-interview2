...
function getLatestInterviews(_a) {
    var userId = _a.userId, _b = _a.limit, limit = _b === void 0 ? 20 : _b;
    return __awaiter(this, void 0, void 0, function () {
        var interviewsRef, q, querySnapshot, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    interviewsRef = (0, firestore_1.collection)(admin_1.db, 'interviews');
                    q = (0, firestore_1.query)(interviewsRef, (0, firestore_1.where)('userId', '!=', userId), (0, firestore_1.where)('finalized', '==', true), limit(limit));
...
function getInterviewsByUserId(userId) {
    return __awaiter(this, void 0, void 0, function () {
        var interviewsRef, q, querySnapshot, interviews, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!userId)
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    interviewsRef = (0, firestore_1.collection)(admin_1.db, "interviews");
                    q = (0, firestore_1.query)(interviewsRef, (0, firestore_1.where)("userId", "==", userId), orderBy("createdAt", "desc"));
                    return [4 /*yield*/, (0, firestore_1.getDocs)(q)];
                case 2:
                    querySnapshot = _a.sent();
                ...
                case 3:
                    error_3 = _a.sent();
                    console.error("Error fetching interviews:", error_3);
                    return [2 /*return*/, null];
